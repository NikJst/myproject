...
public interface IProfileService
{
    ...
    Task<List<ViewPostDto>> GetUserActivity(User me, char i, string username);
}
...
public class ProfileService : IProfileService
{
    ...
    public async Task<List<ViewPostDto>> GetUserActivity(User me, char i, string username)
    {
        ...
        switch (i)
        {
            case '1':
                ...
                var result = await query.Select(CreateExpression(me.Id, logger)).ToListAsync();
            ...
            case '2':
                ...
                var result1 = await query1.Select(CreateExpression(me.Id, logger)).ToListAsync();
            ...
            case '3':
                ...
                var result2 = await query2.Select(CreateExpression(me.Id, logger)).ToListAsync();
    ...
    public Expression<Func<Post, ViewPostDto>> CreateExpression(Guid userId, ILogger? logger = null)
    {
